...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01/06/2026 às 15:03
...
INSERT INTO `doadores` (`id`, `nome`, `sexo`, `cpf`, `telefone`, `email`, `endereco`, `numero`, `cep`, `complemento`, `bairro`, `nasc`, `ts`, `datedonation`, `peso`) VALUES
