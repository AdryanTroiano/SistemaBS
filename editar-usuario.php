...
$sqlTipos = "SELECT id, tipo FROM tipos_sangue ORDER BY tipo";
            ...
            <div class="form-container">
                ...
                <div class="row">
                    <div class="column">
                        ...
                        <input type="text" name="cpf" id="cpf"
                               ...
                               placeholder="Digite o CPF" required readonly>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="column">
                        ...
                        <select name="tipo_sangue_id" id="tipo-sanguineo" required>
                            <option value="" disabled>Selecione o tipo sanguíneo</option>

                            <?php while ($tipo = $resTipos->fetch_assoc()): ?>
                                <option value="<?php echo $tipo['id']; ?>"
                                    <?php echo ($row->tipo_sangue_id == $tipo['id']) ? 'selected' : ''; ?>>
